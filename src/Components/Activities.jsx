...
function Activities() {
  ...
  const categories = ['All', 'Leisure', 'Sightseeing', 'Adventure', 'Education', 'Food', 'Shopping']
      ...
      <div className="main-wrapper">
        ...
        <div className="search-section">
          ...
          <div className="search-buttons">
            {categories.map(cat => (
              <button
                key={cat}
                className={`action-btn ${selectedCategory === cat ? 'active' : ''}`}
        ...
        <div className="regional-section">
          <h2 className="section-title">
            ...
            <span className="result-count"> ({filteredActivities.length} found)</span>
          </h2>
        ...
        <div className="trip-form-section">
          <h2 className="section-title">Can't find your activity? Add a custom one!</h2>
