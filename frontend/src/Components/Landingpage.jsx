...
function Landingpage() {
  ...
  const allRegionalSelections = [
    ...
    },
    {
      ...
      name: "Africa",
      image:
        "https://images.unsplash.com/photo-1489392191049-fc10c97e64b6?w=400",
      className: "africa",
      continent: "Africa",
      popularity: 78,
    },
        ...
        <div className="regional-section">
          <h2 className="section-title">
            ...
            <span className="result-count">
              {" "}
              ({sortedRegions.length} destinations)
            </span>
          </h2>
                ...
                {groupedRegions[groupName].map((region) => (
                  <div key={region.id} className="region-card-image">
                    ...
                    <div className="region-overlay">
                      ...
                      <span className="region-popularity">
                        {region.popularity}% popular
                      </span>
                    </div>
                  </div>
                ))}
          ...
          {sortedRegions.length > 8 && (
            <div className="show-more-container">
              ...
              >
                {showAll
                  ? "Show Less"
                  : `Show More (${sortedRegions.length - 8} more)`}
              </button>
            </div>
          )}
        </div>
        ...
        <div className="trips-section">
          ...
          <div className="trips-grid">
            {previousTrips.map((trip) => (
              <div key={trip.id} className="trip-card-image">
